...
queue()
	.defer(d3.json, 'flickr/Outcome_tiles_library_For_Front/FinalTilesLibrary1.json')
	.await(dataloaded);
...
//         .range([0, 2 * Math.PI]);
	...
	var imgs = container
					...
					//.attr("viewBox", "")
					//.attr("opacity",0.3)
					.attr("x",function(d,i){return imagesize* Math.floor(i / 60) })
					.attr("y", function(d,i){return   imagesize*(i%60) })
					.attr("opacity",0.95)				 
