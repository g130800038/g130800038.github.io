...
queue()
	.defer(d3.json, 'flickr/Outcome_tiles_library_For_Front/SubSingerColorRegionstwo.json')
	.await(dataloaded);
...
//         .range([0, 2 * Math.PI]);
	...
	var imgs = container
					...
					//.attr("viewBox", "")
					//.attr("opacity",0.3)
					.attr("x",function(d,i){return imagesize* Math.floor(i / 40) })
					.attr("y", function(d,i){return   imagesize*(i%40) })
					.attr("opacity",1)				 
